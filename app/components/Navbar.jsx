    ...
    <nav className="fixed w-full z-40 glass-nav transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          <div className="flex items-center gap-2.5 group cursor-pointer">
            <div className="relative">
              ...
              <div className="relative w-10 h-10 bg-white rounded-xl flex items-center justify-center border border-slate-100 shadow-sm">
                <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 24 24" data-icon="solar:layers-minimalistic-bold-duotone" className="iconify text-2xl text-blue-600 iconify--solar">
                  <path
                    fill="currentColor"
          ...
          {/* <!-- Resume Button --> */}
          {hasLastTrx && (
            <button id="resumeBtn" onClick={restoreTransaction} className="none px-4 py-2 bg-amber-100 text-amber-700 rounded-full text-sm font-bold hover:bg-amber-200 transition-colors flex items-center gap-2">

            ...
            <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <button
                  ...
                  disabled={loading}
                  className={`${
                    loading ? "btn-gradient cursor-not-allowed" : "btn-gradient"
                  } w-full btn-gradient text-white font-bold py-4 rounded-xl shadow-lg shadow-blue-100 flex items-center justify-center gap-2 group-hover:gap-3 transition-all`}
                >
                  Kirim Pesan
                </button>
              </form>
